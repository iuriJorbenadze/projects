...
private:
	...
	void grow();
	int  capacity; // How much space is allocated in our array.
	int  usedCap;   // How many elements are logically in the array.
	string* elems;    // The actual array of elements.
	void bubbleUp(string value);
	void bubbleDown() ;

	int findMinIndex(int curIndex);
};
